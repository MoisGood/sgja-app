...
const NAV_ITEMS: NavItem[] = [
  { label: 'Inicio', icono: 'home', ruta: '/biblioteca/m/inicio', roles: [Rol.ADMIN, Rol.ESTUDIANTE] },
  { label: 'Catálogo', icono: 'menu_book', ruta: '/biblioteca/m/catalogo', roles: [Rol.ADMIN, Rol.ESTUDIANTE] },
  { label: 'Config', icono: 'settings', ruta: '/biblioteca/m/config', roles: [Rol.ADMIN] },
  { label: 'Perfil', icono: 'person', ruta: '/biblioteca/m/perfil', roles: [Rol.ADMIN, Rol.ESTUDIANTE] },
];
...
export default function BibliotecaMobileBottomNav({ rol }: Props) {
