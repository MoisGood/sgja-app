...
import { Filter, X, Loader, ClipboardList, ChevronLeft, ChevronRight, Search } from 'lucide-react';
...
export default function MobileTickets({ idEstablecimiento }: Props) {
  ...
  if (cargando && items.length === 0) {
    return (
      <div style={{ maxWidth: 500, margin: '0 auto', minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        <div className="animate-spin"><Loader size={24} /></div>
      </div>
    );
  }
    ...
    <div style={{ maxWidth: 500, margin: '0 auto' }}>
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
          <button onClick={() => navigate('/tecnico/m/historial')}
            style={{ width: 40, height: 40, display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: 9999, border: 'none', background: 'transparent', cursor: 'pointer' }}
          >
            <Search size={20} />
          </button>
          ...
          >
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: 4, flexWrap: 'wrap' }}>
                {['Pendiente', 'En Proceso', 'Esperando Repuesto', 'Completada', 'Cancelada'].map(e => (
            ...
            <div style={{ display: 'flex', gap: 6 }}>
              ...
              <div style={{ flex: 1 }}>
                <label style={{ fontSize: 10, color: '#6B7280', display: 'block', marginBottom: 2 }}>Técnico</label>
            ...
            {items.map(r => (
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
                  ...
                  <span style={{ fontSize: 10, color: '#9CA3AF', display: 'flex', gap: 4 }}>
                    <span style={{
        ...
        {totalPaginas > 1 && (
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, padding: '16px 0' }}>
            <motion.button whileTap={{ scale: 0.9 }} onClick={() => irPagina(1)} disabled={pagina === 1}
              style={{ background: 'none', border: 'none', cursor: pagina === 1 ? 'default' : 'pointer', color: pagina === 1 ? '#D1D5DB' : '#374151', padding: 4, fontSize: 13 }}>
              {'<<'}
            </motion.button>
            ...
            <motion.button whileTap={{ scale: 0.9 }} onClick={() => irPagina(totalPaginas)} disabled={pagina === totalPaginas}
              style={{ background: 'none', border: 'none', cursor: pagina === totalPaginas ? 'default' : 'pointer', color: pagina === totalPaginas ? '#D1D5DB' : '#374151', padding: 4, fontSize: 13 }}>
              {'>>'}
            </motion.button>
          </div>
        )}
